#+title: TriplyDB Documentation
#+email: (concat "support" at-sign "triply.cc")
#+language: en-us
...
work-in-process.  Contact [[mailto:support@triply.cc][support@triply.cc]] for more information.
...
[[https://wouterbeek.github.io/resource/img/triply/add-dataset-dialog.png]]
...
#+name: add-data
[[https://wouterbeek.github.io/resource/img/triply/add-data.png]]
...
#+name: upload-error
[[https:/wouterbeek.github.io/resource/img/triply/upload-error.png]]
...
#+name: cog-wheel
[[https://wouterbeek.github.io/resource/img/triply/cog-wheel.png]]
...
[[https://wouterbeek.github.io/resource/img/triply/dataset-settings-page.png]]
...
[[https://wouterbeek.github.io/resource/img/triply/dataset-homepage-with-metadata.png]]
...
#+name: slack-widget
[[https://wouterbeek.github.io/resource/img/triply/slack-widget.png]]

** Starting services

By default, datasets in TriplyDB can be queried through the [[https://wouterbeek.github.io/page/TriplyClient.html][Triply
...
#+name create-service
[[https://wouterbeek.github.io/resource/img/triply/create-service.png]]
...
#+name service-widget
[[https://wouterbeek.github.io/resource/img/triply/service-widget.png]]
...
implements [[http://www.hydra-cg.com/spec/latest/triple-pattern-fragments/][Triple Pattern Fragments]] version 2019-01-18 and [[http://www.hydra-cg.com/spec/latest/linked-data-fragments/][Linked Data
Fragments]] version 2016-06-05.
...
~rdf:HTML~.  You can [[https://demo.triply.cc/academy/pokemon/queries/sparql-html/2][try this query online]].
...
You can [[https://demo.triply.cc/academy/pokemon/queries/sparql-templating/2][try this query online]].
...
#+end_src
[[https://api.demo.triply.cc/s/0lhnUC9v9][Run this query online]]

#+attr_html: width="800px"
#+attr_org: :width 800
#+caption: Screenshot of the SPARQL Table view over the above query.
#+name: sparql-table-example
[[https://wouterbeek.github.io/resource/img/triply/sparql-table-example.png]]
...
displaying a Pokémon.  (This SPARQL query also uses [[SPARQL Templates]]
in order to simplify its syntax.)  This query can be [[https://demo.triply.cc/academy/pokemon/queries/gallery][run online]].

#+caption: SPARQL Gallery view of a Pokémon query that uses SPARQL Templating.
#+name: pokémon-gallery
[[https://wouterbeek.github.io/resource/img/triply/pokémon-gallery.png]]
...
See [[https://developer.mozilla.org/en-US/docs/Web/CSS/color_value][MDN]].
...
See [[https://www.npmjs.com/package/colormap][colormap]].

****** Color Brewer

See [[http://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3][Color Brewer]].
...
tabnagging, a serious security vulnerability explained in [[https://www.jitbit.com/alexblog/256-targetblank---the-most-underestimated-vulnerability-ever/][this article]].
...
#+name: sparql-table-example
[[https://wouterbeek.github.io/resource/img/triply/admin-settings.png]]
